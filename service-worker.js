const CACHE='vertex-shell-v8',SHELL=['/','/index.html','/css/style.css','/js/app.js','/js/api.js','/js/components.js','/js/auth-enhancements.js','/config.js','/assets/logo.png','/manifest.webmanifest'];
